...
<body background="bc.png">
    <div class="wrap">
        ...
        <div class="header">          
            <h1><font face="Century Gothic">BoomWeb.id</font></h1>
            <div class="tanggal">
                <?php
                    // Real Time Clock
                    echo date('d F Y');
        ...
        <div class="content"><center>
            ...
            <h2>Selamat Datang di BoomWeb.id</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Muhammad Fachrurazi</td></tr>
                <tr><td>NIM</td><td>:</td><td>11170910000071</td></tr>
                <tr><td>Program Studi</td><td>:</td><td>Teknik Informatika 2017</td></tr>
                </table>
        ...
        <div class="footer">
            Copyright @2019 Muhammad Fachrurazi 
        </div>
    </div>
</body>
</html>
